"""
Detector Agent Configuration — Staging Edition.

Configuration for the HaluEval-trained hallucination detector.
Supports environment variable overrides for model paths and risk thresholds.
"""
...
class DetectorConfig(ConfigBase):
    ...
    halueval_model_path: str = Field(
        ...
        description="Path to the fine-tuned HaluEval model directory or HF repo identifier."
    )
